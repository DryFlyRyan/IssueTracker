...
module.exports = {
  // app paths
  actionCreators: resolveApp('src/data/actionCreators'),
  ...
  appPackagesList: resolveApp('appPackagesList.json'),
  appPath: resolveApp('.'),
  ...
  'styled-components': resolveApp('node_modules/styled-components'),
};
